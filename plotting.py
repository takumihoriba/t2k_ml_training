...
def efficiency_plots(inputPath, arch_name, newest_directory, plot_output, label=None):
    ...
    visible_energy_binning = get_binning(ml_visible_energy, 10, minimum=0, maximum=1000) # how to change this binning? #get_binning(ml_visible_energy, 10, minimum=0, maximum=1000)
